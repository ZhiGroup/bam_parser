...
int main(int argc, char * argv[])
{
  ...
  if (argc > 6 )  {
    if (argv[6][0] == 'v')
      verbose = 1;
        ...
        cerr << "Too many arguments:" << argc << endl;
    cerr << "Usage: A  x  y  A*x   A'*y   (filenames)" << endl;
      return -1;
    }
  }
  ...
  if (errcount > 0) {
    ...
    cout << "Accord(1,1)=" << Acoord(1,1) << endl;
    cout << "Accord(1,5)=" << Acoord(1,5) << endl;
    cout << "Accord(3,1)=" << Acoord(3,1) << endl;
    cout << "Accord(4,2)=" << Acoord(4,2) << endl;
    cout << "Accord(1,3)=" << Acoord(1,3) << endl;
    cout << "Accord(0,4)=" << Acoord(0,4) << endl;
